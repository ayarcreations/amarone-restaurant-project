        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 lg:gap-24">
          ...
          >
             <div className="aspect-[4/5] sm:aspect-[3/4] md:aspect-[1/1] lg:aspect-[4/3] bg-stone-100 overflow-hidden relative">
               <img public="/han.jpg" alt="Jan & Yoshiko" loading="lazy" decoding="async" className="w-full h-full object-cover object-[center_25%] sm:object-[center_30%] md:object-[center_20%] grayscale-[30%]" />
            </div>
          </motion.div>
        </div>
      </section>
